...
const cardAppender = (selector) =>{
  ...
  .then(res =>{ 
    const  articleArr = [];
    articleArr.push(res.data.articles.javascript);
    articleArr.push(res.data.articles.bootstrap);
    articleArr.push(res.data.articles.techology);
    articleArr.push(res.data.articles.node);
